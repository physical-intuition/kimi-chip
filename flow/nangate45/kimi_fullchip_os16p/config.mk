export DESIGN_NAME = fullchip_os16p
export DESIGN_NICKNAME = kimi_fullchip_os16p
export PLATFORM = nangate45
export VERILOG_FILES = $(wildcard $(DESIGN_HOME)/src/kimi_fullchip_os16p/*.v)
export SDC_FILE = $(DESIGN_HOME)/nangate45/kimi_fullchip_os16p/constraint.sdc
