...
// X1-Y4 keeps Y3's verified microarchitecture and closes the remaining
// post-route maximum-capacitance violations with physical-design margin.
// Keeping the logical design fixed makes this a controlled experiment: Y4
// measures electrical closure rather than mixing it with an RTL redesign.
module x1_y4_kimi (
    input  wire         clk,
    input  wire         rst_n,
    input  wire         start,
    ...
    output wire [11:0]  weight_addr,
    input  wire [63:0]  weight_rdata,
    output wire         out_we,
    output wire [13:0]  out_addr,
    output wire [23:0]  out_wdata,
    output wire         busy,
    output wire         done
);
    x1_y3_kimi core (
