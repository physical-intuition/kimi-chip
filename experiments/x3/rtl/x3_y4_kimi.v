...
// X3-Y4 keeps the proven datapath while strengthening the locked regression
// with control-plane assertions for request pairing, address uniqueness, latched k_dim, and busy-start immunity.
module x3_y4_kimi (
