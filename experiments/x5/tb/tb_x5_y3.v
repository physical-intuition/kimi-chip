...
module tb_x5_y3;
    ...
    initial begin
        ...
        abort_and_restart();
        run_case(65535);
        $display("PASS: X5-Y3 registered-request + MAC-pipeline request-product-commit pipeline, hierarchical fold, tail flush, reset/restart, signed extrema, exactly-once, and K=65535 verified");
        $finish;
    end
