...
// X2-Y3 preserves the executable-linted indexed-readout datapath and bisects
// the physical closure interval. CAP_MARGIN=20 left one extracted max-cap
// violation, while CAP_MARGIN=30 closed cleanly with measurable area/fmax cost.
module x2_y3_kimi (
