...
// X2-Y5 preserves the executable-linted indexed-readout datapath and performs
// the final boundary refinement. CAP_MARGIN=20 failed strict extraction while
// CAP_MARGIN=22 closed cleanly, so this cell tests the intervening margin 21.
module x2_y5_kimi (
